...
function RegisterPage() {
    ...
    return (
        <div className="bg-[#051321] h-screen flex justify-center items-center">
            <div className="border border-2 bg-[#040f1a] w-[440px] border-slate-800 rounded-lg p-10">
                ...
                <form onSubmit={handleSubmit} className="text-white">
                    ...
                    <div className="my-4">
                        ...
                        <input type="text" className="bg-black p-2 w-full border border-gray-400 rounded-lg text-white" placeholder="name" name="name" value={formData.name} onChange={handleChange} />
                    </div>
                    <div className="mb-4">
                    ...
                    <p className="text-center mt-5">Already have an account? <button className="underline underline-offset-3" onClick={()=> navigate('/login')}>Login</button></p>
                </form>
            </div>
        </div>
    );
